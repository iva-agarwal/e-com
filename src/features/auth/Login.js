...
import { checkUserAsync, selectError, selectLoggedInUser, setEmailAndPassword} from './authSlice';
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          className="space-y-6" action="#" method="POST">
            <div>
              ...
              <input
               id="email"
               {...register("email",{ required: 'E-mail password required',
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Not a member?{' '}
            <Link to='/signup' className="font-semibold leading-6 text-black-600 hover:text-black-500">
             Create Account
            </Link>
          </p>
        </div>
